...
export default function Barbers() {
 ...
 useEffect(() => {
  ...
  return (
    <div>
      <Header />
      <h3 className="page-title">Crew profiles</h3>
      <div className="profile-container">
        <img className="profile-pic barbpic1" data-aos="fade-left" data-aos-duration="2000" src={barber1} alt="barber-profile1" />
        <p className="barber-p barbp1">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis
          eaque harum rerum excepturi quisquam! Numquam.
        </p>
        <img className="profile-pic barbpic2" data-aos="fade-right" data-aos-duration="2000" src={barber2} alt="barber-profile2" />
        ...
        <img className="profile-pic barbpic3" data-aos="fade-left" data-aos-duration="2000" src={barber3} alt="barber-profile3" />
        ...
        <img className="profile-pic barbpic4" data-aos="fade-right" data-aos-duration="2000" src={barber4} alt="barber-profile4" />
